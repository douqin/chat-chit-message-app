...
exports.TsGoogleDrive = exports.FIELDS = exports.GOOGLE_DRIVE_UPLOAD_API = exports.GOOGLE_DRIVE_API = void 0;
var fs = __importStar(require("fs"));
var path = __importStar(require("path"));
var AuthClientBase_1 = require("./AuthClientBase");
...
var TsGoogleDrive = /** @class */ (function (_super) {
    __extends(TsGoogleDrive, _super);
    function TsGoogleDrive(options) {
        return _super.call(this, options) || this;
    }
    TsGoogleDrive.prototype.query = function () {
        return new Query_1.Query(this.options);
    };
    // https://developers.google.com/drive/api/v3/reference/files/get
    TsGoogleDrive.prototype.getFile = function (id) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        err_1 = _b.sent();
                        if (typeof err_1 === "object" && ((_a = err_1) === null || _a === void 0 ? void 0 : _a.code) === 404) {
    ...
    TsGoogleDrive.prototype.createFolder = function (options) {
    ...
    // https://developers.google.com/drive/api/v3/reference/files/create
    TsGoogleDrive.prototype.upload = function (filename, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    TsGoogleDrive.prototype.emptyTrash = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return TsGoogleDrive;
}(AuthClientBase_1.AuthClientBase));
exports.TsGoogleDrive = TsGoogleDrive;
